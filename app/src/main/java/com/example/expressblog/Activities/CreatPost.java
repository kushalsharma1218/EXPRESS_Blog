...
public class CreatPost extends AppCompatActivity implements DraftAdapter.DraftAdapterListener {
    ...
    DraftAdapter.DraftAdapterListener draftAdapterListener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boldText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(CreatPost.this, "Bold Clicked", Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(CreatPost.this, "Error" + error, Toast.LENGTH_LONG).show();
...
//        finish();
    ...
    public void sendData(String title, String blogBody) {
        inputPostTitle.setText(title);
        inputContent.setText(blogBody);
    }
}
